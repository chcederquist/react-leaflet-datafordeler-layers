...
import { Opstillingskreds } from '../WFS/DAGI/Opstillingskreds';

const meta = {
  title: 'Opstillingskreds',
  component: Opstillingskreds,
...
} satisfies Meta<typeof Opstillingskreds>;

export default meta;
type Story = StoryObj<typeof meta>;

export const OpstillingskredsMap: Story = {
  args: {
